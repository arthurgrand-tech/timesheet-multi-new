...
export default function PlatformTenants() {
  ...
  const updateTenantMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: Partial<TenantData> }) => {
                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                    ...
                    <div className="flex justify-end space-x-2 pt-4">
                      ...
                      <Button 
                        type="submit"
                        className="bg-gradient-to-r from-[#787dbd] to-[#f17f85] hover:from-[#6a6fb0] hover:to-[#ef727a]"
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <DropdownMenu>
                              <DropdownMenuTrigger asChild>
                                <Button variant="outline" className="h-[32px] w-[80px] rounded-lg border-gray-300 text-xs">
